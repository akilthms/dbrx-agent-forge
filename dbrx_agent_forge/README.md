...
The 'dbrx_agent_forge' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dbrx_agent_forge_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/dbrx_agent_forge.job.yml). The schedule
